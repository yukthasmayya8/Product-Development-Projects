      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-3 gap-6">
          {moods.map((m) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-br ${m.color} opacity-0 group-hover/btn:opacity-10 transition-opacity`}
              />

              <div
                className={`p-5 rounded-3xl mb-4 shadow-2xl bg-gradient-to-br ${m.color} text-white relative z-10`}
              >
                {isSaving && selectedMood === m.label ? (
