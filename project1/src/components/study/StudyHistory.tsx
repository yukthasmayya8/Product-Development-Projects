...
export default function StudyHistory({
  ...
  const filteredSessions = sessions.filter((s) => {
    ...
    const matchesEnd =
      !endDate ||
      sessionDate <= new Date(new Date(endDate).setHours(23, 59, 59));
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-[10px] uppercase tracking-widest font-bold opacity-40">
            Chronicle of Your Academic Journey
          </p>
        </div>
          ...
          >
            <div className="glass-surface rounded-[32px] p-8 border border-white/10 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-3">
                <label className="text-[9px] uppercase tracking-widest font-black opacity-30 ml-2">
                  {t.filterBySubject}
                </label>
                <select
                  value={filterSubject}
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 opacity-40">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Clock size={12} />
                        <span className="text-[10px] uppercase tracking-wider font-bold">
                          {session.timestamp?.toLocaleTimeString(undefined, {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </span>
                ...
                <div className="flex items-center gap-8">
                  <div className="text-right">
                    ...
                    <p className="text-xl font-display font-black text-[#ff4e00]">
                      {session.durationMinutes}{" "}
                      <span className="text-[10px] opacity-40 lowercase italic font-serif">
                        {t.minutes}
                      </span>
                    </p>
                  </div>
