      ...
      <div className="space-y-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            {errors.concept && (
              <p className="text-[10px] text-red-500 font-bold uppercase tracking-widest flex items-center gap-1">
                <AlertCircle size={10} /> {errors.concept}
              </p>
            )}
          </div>
        </div>
              ...
              <div className="glass-surface rounded-[32px] p-8 border border-white/10 space-y-8">
                <div className="flex justify-center">
                  <div className="px-6 py-2 bg-[#ff4e00]/10 border border-[#ff4e00]/20 rounded-full">
                    <span className="text-xs font-bold text-[#ff4e00]">
                      Score: {reviewQuiz.score} / {reviewQuiz.questions.length}
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-3">
                  {savedQuizzes.slice(0, 5).map((q) => (
                    ...
                    >
                      <div>
                        <h5 className="text-sm font-bold mb-1 group-hover:text-[#ff4e00] transition-colors">
                          {q.subject}
                        </h5>
                        <p className="text-[10px] opacity-40 uppercase tracking-widest">
                          {q.concept}
            ...
            >
              ...
              <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{
                    width: `${((currentCardIdx + 1) / flashcards.length) * 100}%`,
                  }}
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 backface-hidden glass-surface rounded-[32px] p-8 flex flex-col items-center justify-center text-center border border-white/10">
                    <span className="text-[8px] uppercase tracking-[0.4em] font-bold opacity-20 mb-4">
                      Concept
                    </span>
                    <h4 className="text-2xl font-bold tracking-tight">
                      {flashcards[currentCardIdx].concept}
                    </h4>
                  </div>
                  {/* Back */}
                  <div className="absolute inset-0 backface-hidden glass-surface rounded-[32px] p-8 flex flex-col items-center justify-center text-center border border-[#ff4e00]/30 rotate-y-180 bg-[#ff4e00]/5">
                    ...
                    <p className="text-lg font-light leading-relaxed italic">
                      {flashcards[currentCardIdx].explanation}
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            >
              ...
              <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{
                    width: `${((currentQuestionIdx + (quizComplete ? 1 : 0)) / quiz.length) * 100}%`,
                  }}
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center px-2">
                    <span className="text-[10px] font-bold opacity-40 tracking-widest uppercase">
                      Question {currentQuestionIdx + 1} / {quiz.length}
                    </span>
                    <span className="text-[10px] font-bold text-[#ff4e00] tracking-widest uppercase">
                      Score: {score}
                    </span>
                  </div>
                  <div className="glass-surface rounded-[32px] p-8 border border-white/10">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {quiz[currentQuestionIdx].options.map(
                        (option: string) => (
                          <button
                            key={option}
                            onClick={() =>
